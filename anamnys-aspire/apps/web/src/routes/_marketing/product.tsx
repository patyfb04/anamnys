      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {steps.map((step, i) => (
            <div
              key={step.title}
              className="bg-surfaceContainerLowest border border-outlineVariant rounded-radii-lg p-6"
            >
        ...
        <div className="flex flex-col gap-5 mt-8">
          {upcomingGroups.map((group, gi) => {
            ...
            return (
              <div
                key={group.title}
                className="bg-surfaceContainerLow border border-outlineVariant rounded-radii-lg p-6"
              >
