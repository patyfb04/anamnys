...
import AlertMessage from "@anamnys/shared/ui/AlertMessage";
import { contactApi } from "@anamnys/shared/api/contact";

export const Route = createFileRoute("/_marketing/contact-support")({
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="relative rounded-radii-xl overflow-hidden border border-primary/20 min-h-55 flex flex-col items-center justify-center text-center p-6">
            <img src="/suport.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
